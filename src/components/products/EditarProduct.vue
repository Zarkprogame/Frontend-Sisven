                ...
                <form @submit.prevent="updateProduct">
                    <div class="row mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" id="id" placeholder="ID del Producto" disabled v-model='product.id'>
                        </div>
                    </div>
                    <div class="row mb-3">
...
export default {
    ...
    methods: {
        ...
        async updateProduct() {
            try {
                const res = await axios.put(`http://127.0.0.1:8000/api/products/${this.$route.params.id}`, this.product);
                if (res.status === 200) {
                    this.$router.push({ name: 'products' });
                    Swal.fire({
                        position: 'top-end',
